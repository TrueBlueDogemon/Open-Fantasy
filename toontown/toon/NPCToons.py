...
HQnpcFriends = {2001: (ToontownBattleGlobals.HEAL_TRACK,
                ...
                1329: (ToontownBattleGlobals.NPC_RESTOCK_GAGS,
                       ...
                       0,
                       3),
                7010: (ToontownBattleGlobals.DROP_TRACK,
                       5,
                       200,
                       5)}
...
def npcFriendsMinMaxStars(minStars, maxStars):
    return [id for id in list(npcFriends.keys()) if getNPCTrackLevelHpRarity(
        id)[3] >= minStars and getNPCTrackLevelHpRarity(id)[3] <= maxStars]
